 ...
 *
 * Emitted when a user accepts an AI suggestion.
 */

/**
 * AI Suggestion Accepted Event JSON
 */
export interface AISuggestionAcceptedEventV1JSON {
  eventId: string;
  eventType: 'AISuggestionAcceptedEvent-V1';
  eventVersion: '1.0.0';
  occurredAt: string;
  aggregateId: string;
...
/**
 * AI Suggestion Accepted Event V1
 *
 * Emitted whenever a user accepts an AI suggestion.
 * This is used for feedback loops and analytics.
 */
export class AISuggestionAcceptedEventV1 {
  readonly eventId: string;
  readonly eventType: 'AISuggestionAcceptedEvent-V1' = 'AISuggestionAcceptedEvent-V1';
   ...
   * Serialize to JSON
   */
  toJSON(): AISuggestionAcceptedEventV1JSON {
    return {
   ...
   */
  static fromJSON(json: AISuggestionAcceptedEventV1JSON): AISuggestionAcceptedEventV1 {
    return new AISuggestionAcceptedEventV1({
