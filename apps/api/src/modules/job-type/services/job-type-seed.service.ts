  ...
  [Vertical.DELIVERY]: [
    {
      ...
      metadataFields: [
        { fieldKey: 'pickup_address', displayName: 'Pickup Address', fieldType: 'address', required: true, isCustomerEditable: true },
        { fieldKey: 'delivery_address', displayName: 'Delivery Address', fieldType: 'address', required: true, isCustomerEditable: true },
        { fieldKey: 'package_description', displayName: 'Package Description', fieldType: 'text', required: true },
        { fieldKey: 'package_weight', displayName: 'Package Weight (kg)', fieldType: 'number', required: false },
        { fieldKey: 'delivery_instructions', displayName: 'Delivery Instructions', fieldType: 'text', required: false },
      ],
    ...
    },
    {
      ...
      metadataFields: [
        ...
        { fieldKey: 'delivery_address', displayName: 'Delivery Address', fieldType: 'address', required: true, isCustomerEditable: true },
        { fieldKey: 'package_description', displayName: 'Package Description', fieldType: 'text', required: true },
        { fieldKey: 'delivery_time', displayName: 'Required Delivery Time', fieldType: 'datetime', required: true },
      ],
      assignmentStrategy: { type: 'auto' },
    ...
    },
    {
      ...
      metadataFields: [
        { fieldKey: 'pickup_address', displayName: 'Pickup Address', fieldType: 'address', required: true, isCustomerEditable: true },
        { fieldKey: 'delivery_address', displayName: 'Delivery Address', fieldType: 'address', required: true, isCustomerEditable: true },
        { fieldKey: 'scheduled_date', displayName: 'Scheduled Date', fieldType: 'date', required: true, isCustomerEditable: true },
        { fieldKey: 'scheduled_time', displayName: 'Scheduled Time', fieldType: 'datetime', required: true, isCustomerEditable: true },
        { fieldKey: 'package_details', displayName: 'Package Details', fieldType: 'text', required: true },
      ],
  ...
  [Vertical.MOVING]: [
    {
      ...
      metadataFields: [
        { fieldKey: 'pickup_address', displayName: 'Pickup Address', fieldType: 'address', required: true },
        { fieldKey: 'destination_address', displayName: 'Destination Address', fieldType: 'address', required: true },
        { fieldKey: 'move_date', displayName: 'Move Date', fieldType: 'date', required: true },
        { fieldKey: 'floor_number', displayName: 'Floor Number', fieldType: 'number', required: false },
        { fieldKey: 'has_elevator', displayName: 'Has Elevator', fieldType: 'boolean', required: false },
        { fieldKey: 'inventory_list', displayName: 'Inventory List', fieldType: 'file', required: true },
        { fieldKey: 'special_items', displayName: 'Special Items', fieldType: 'text', required: false },
      ],
      assignmentStrategy: { type: 'auto' },
    ...
    },
    {
      ...
      metadataFields: [
        ...
        { fieldKey: 'destination_address', displayName: 'Destination Address', fieldType: 'address', required: true },
        { fieldKey: 'move_date', displayName: 'Move Date', fieldType: 'date', required: true },
        { fieldKey: 'company_name', displayName: 'Company Name', fieldType: 'text', required: true },
        { fieldKey: 'employee_count', displayName: 'Number of Employees', fieldType: 'number', required: false },
        { fieldKey: 'it_equipment_count', displayName: 'IT Equipment Count', fieldType: 'number', required: false },
      ],
      assignmentStrategy: { type: 'hybrid', hybridConfig: { autoThresholdMinutes: 30, escalateOnThresholdBreach: true } },
  ...
  [Vertical.WHOLESALE]: [
    {
      ...
      metadataFields: [
        { fieldKey: 'warehouse_pickup', displayName: 'Warehouse Pickup Location', fieldType: 'address', required: true },
        { fieldKey: 'destinations', displayName: 'Delivery Destinations', fieldType: 'multiselect', required: true },
        { fieldKey: 'delivery_window_start', displayName: 'Delivery Window Start', fieldType: 'datetime', required: true },
        { fieldKey: 'delivery_window_end', displayName: 'Delivery Window End', fieldType: 'datetime', required: true },
        { fieldKey: 'cargo_manifest', displayName: 'Cargo Manifest', fieldType: 'file', required: true },
      ],
      assignmentStrategy: { type: 'auto' },
  ...
  [Vertical.FLEET]: [
    {
      ...
      metadataFields: [
        { fieldKey: 'pickup_location', displayName: 'Pickup Location', fieldType: 'address', required: true },
        { fieldKey: 'charter_duration', displayName: 'Charter Duration (hours)', fieldType: 'number', required: true },
        { fieldKey: 'vehicle_count', displayName: 'Number of Vehicles', fieldType: 'number', required: true },
        { fieldKey: 'driver_count', displayName: 'Number of Drivers', fieldType: 'number', required: true },
        { fieldKey: 'route_description', displayName: 'Route Description', fieldType: 'text', required: false },
      ],
      assignmentStrategy: { type: 'manual' },
  ...
  [Vertical.MARKETPLACE]: [
    {
      ...
      metadataFields: [
        { fieldKey: 'pickup_location', displayName: 'Pickup Location', fieldType: 'address', required: true, isCustomerEditable: true },
        { fieldKey: 'delivery_location', displayName: 'Delivery Location', fieldType: 'address', required: true, isCustomerEditable: true },
      ...
      assignmentStrategy: { type: 'bidding', biddingConfig: { biddingWindowMinutes: 5, minBidders: 1, visibility: 'nearby' } },
    ...
    },
    {
      ...
      metadataFields: [
        { fieldKey: 'pickup_address', displayName: 'Pickup Address', fieldType: 'address', required: true, isCustomerEditable: true },
        { fieldKey: 'delivery_address', displayName: 'Delivery Address', fieldType: 'address', required: true, isCustomerEditable: true },
        { fieldKey: 'scheduled_time', displayName: 'Preferred Time', fieldType: 'datetime', required: false, isCustomerEditable: true },
        { fieldKey: 'service_type', displayName: 'Service Type', fieldType: 'select', required: true, isCustomerEditable: true, options: [{ value: 'delivery', label: 'Delivery' }, { value: 'errand', label: 'Errand' }] },
      ],
      assignmentStrategy: { type: 'auto' },
...
export class JobTypeSeedService {
   ...
   */
  private async createFromTemplate(workspaceId: string, template: CreateJobTypeCommandInput): Promise<void> {
