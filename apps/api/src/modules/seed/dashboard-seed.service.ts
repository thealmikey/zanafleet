...
export class DashboardSeedService implements OnModuleInit {
  ...
  private async seedBusinesses(): Promise<BusinessEntity[]> {
    const bizDefs = [
      ...
      { name: 'Zana Supermarket', type: BusinessType.Wholesale, lat: -1.29, lng: 36.81 },
      { name: 'Kariokor Spare Parts', type: BusinessType.Retail, lat: -1.28, lng: 36.835 },
      { name: 'Westlands Fast Food', type: BusinessType.Restaurant, lat: -1.265, lng: 36.808 },
      { name: 'Global Logistics Hub', type: BusinessType.Logistics, lat: -1.32, lng: 36.85 },
    ];
