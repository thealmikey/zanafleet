...
export class CustomerController {
  ...
  @ApiOperation({
    ...
    description: 'Search for customers by name or phone number within a business',
  })
  ...
  async search(@Query('businessId') businessId: string, @Query('query') query: string) {
    if (!businessId) {
      return { data: [] };
    }
  ...
  @ApiOperation({
    ...
    description: 'Retrieve business availability information for customers',
  })
