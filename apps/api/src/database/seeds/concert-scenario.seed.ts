...
export const ConcertTrips = [
    // Setup Day Pickups (Day -1: Mar 15, 2026)
    {
        ...
        endTime: null,
        metadata: { pickupLocation: 'Westlands', dropoffLocation: 'Uhuru Park', purpose: 'Stage Equipment' },
    },
    {
        id: uuidv4(),
        bundleId: NairobiMusicFestivalBundle.id,
        ...
        endTime: null,
        metadata: { pickupLocation: 'Industrial Area', dropoffLocation: 'Uhuru Park', purpose: 'Scaffolding' },
    },
    {
        id: uuidv4(),
        bundleId: NairobiMusicFestivalBundle.id,
        ...
        endTime: null,
        metadata: { pickupLocation: 'Karen', dropoffLocation: 'Uhuru Park', purpose: 'Catering Supplies' },
    },
    {
        id: uuidv4(),
        bundleId: NairobiMusicFestivalBundle.id,
        ...
        endTime: null,
        metadata: { pickupLocation: 'Embakasi', dropoffLocation: 'Uhuru Park', purpose: 'Portable Toilets' },
    },
];
