...
class Settings
{
    ...
    private function get_sections(): array
    {
        return [
            ...
            'onboarding' => __('Onboarding', 'zanafleet'),
    ...
    private function get_settings_fields(): array
    {
        return [
            ...
            'onboarding' => [
                [
                    'title' => __('ZanaFleet Onboarding', 'zanafleet'),
                    'type' => 'title',
                    'desc' => __('Connect your WooCommerce store to ZanaFleet for delivery services.', 'zanafleet'),
                ],
                [
                    'title' => __('Store Name', 'zanafleet'),
                    'desc' => __('Your business/store name', 'zanafleet'),
                    'id' => 'zanafleet_settings[store_name]',
                    'type' => 'text',
                    'class' => 'regular-text',
                ],
                [
                    'title' => __('Business Type', 'zanafleet'),
                    'desc' => __('Type of business', 'zanafleet'),
                    'id' => 'zanafleet_settings[business_type]',
                    'type' => 'select',
                    'options' => [
                        'retail' => __('Retail', 'zanafleet'),
                        'restaurant' => __('Restaurant', 'zanafleet'),
                        'grocery' => __('Grocery', 'zanafleet'),
                        'pharmacy' => __('Pharmacy', 'zanafleet'),
                        'electronics' => __('Electronics', 'zanafleet'),
                        'fashion' => __('Fashion', 'zanafleet'),
                        'other' => __('Other', 'zanafleet'),
                    ],
                ],
                [
                    'title' => __('Admin First Name', 'zanafleet'),
                    'desc' => __('First name of the store admin', 'zanafleet'),
                    'id' => 'zanafleet_settings[admin_first_name]',
                    'type' => 'text',
                    'class' => 'regular-text',
                ],
                [
                    'title' => __('Admin Last Name', 'zanafleet'),
                    'desc' => __('Last name of the store admin', 'zanafleet'),
                    'id' => 'zanafleet_settings[admin_last_name]',
                    'type' => 'text',
                    'class' => 'regular-text',
                ],
                [
                    'title' => __('Phone Number', 'zanafleet'),
                    'desc' => __('Contact phone number (e.g., +254700000000)', 'zanafleet'),
                    'id' => 'zanafleet_settings[phone_number]',
                    'type' => 'text',
                    'class' => 'regular-text',
                ],
                [
                    'title' => __('Business Address', 'zanafleet'),
                    'desc' => __('Street address', 'zanafleet'),
                    'id' => 'zanafleet_settings[address_street]',
                    'type' => 'text',
                    'class' => 'regular-text',
                ],
                [
                    'title' => __('City', 'zanafleet'),
                    'desc' => __('City', 'zanafleet'),
                    'id' => 'zanafleet_settings[address_city]',
                    'type' => 'text',
                    'class' => 'regular-text',
                ],
                [
                    'title' => __('County/State', 'zanafleet'),
                    'desc' => __('County or State', 'zanafleet'),
                    'id' => 'zanafleet_settings[address_county]',
                    'type' => 'text',
                    'class' => 'regular-text',
                ],
                [
                    'title' => __('Connect to ZanaFleet', 'zanafleet'),
                    'type' => 'button',
                    'desc' => __('Click to register your store with ZanaFleet and get API credentials', 'zanafleet'),
                    'id' => 'zanafleet_settings[onboard_button]',
                    'class' => 'button button-primary',
                    'button_text' => __('Register Store', 'zanafleet'),
                ],
            ],
            'api' => [
                [
    ...
    /**
     * Enqueue admin scripts for onboarding
     */
    public function enqueue_admin_scripts($hook)
    {
        ...
        wp_enqueue_script(
            'zanafleet-admin-onboarding',
            ZANAFLEET_PLUGIN_URL . 'assets/js/admin-onboarding.js',
            ['jquery'],
            ZANAFLEET_VERSION,
            true
        );
        ...
        wp_localize_script('zanafleet-admin-onboarding', 'zanafleetAdmin', [
            'baseUrl' => get_option('zanafleet_settings')['base_url'] ?? 'http://localhost:3000/api/v1',
