...
final class Delivery
{
    ...
    public function getCurrency(): string { return $this->meta['currency'] ?? 'KES'; }
    public function getCustomerId(): ?string { return $this->meta['customer_id'] ?? null; }
    public function getCancellationReason(): ?string { return $this->meta['cancellation_reason'] ?? null; }
    public function getTimeline(): array { return $this->meta['timeline'] ?? []; }
    public function getDriverName(): ?string { return $this->meta['driver_name'] ?? null; }
    public function getDriverPhone(): ?string { return $this->meta['driver_phone'] ?? null; }
    public function getCurrentLocation(): ?string { return $this->meta['current_location'] ?? null; }
    public function getPreferredTimeSlot(): ?string { return $this->meta['preferred_time_slot'] ?? null; }
    public function getVehicleType(): ?string { return $this->meta['vehicle_type'] ?? null; }
    public function getSlaType(): ?string { return $this->meta['sla_type'] ?? null; }
    public function getPaymentType(): ?string { return $this->meta['payment_type'] ?? null; }
    public function getCodAmount(): ?float { return $this->meta['cod_amount'] ?? null; }
    public function getCodStatus(): ?string { return $this->meta['cod_status'] ?? null; }
    public function getOtp(): ?string { return $this->meta['otp'] ?? null; }
