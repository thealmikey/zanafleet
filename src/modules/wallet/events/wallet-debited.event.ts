/**
 * WalletDebitedEventV1
 *
 * Append-only event emitted when funds are debited from a wallet.
 *
 * Event Contract:
 ...
 */
export class WalletDebitedEventV1 {
  readonly eventId: string;
  readonly eventType: 'WalletDebitedEvent-V1' = 'WalletDebitedEvent-V1';
  ...
  static fromJSON(data: {
    ...
    return new WalletDebitedEventV1({
