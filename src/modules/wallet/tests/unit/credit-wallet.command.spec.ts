 ...
 */
describe('CreditWalletCommand Unit Tests', () => {
  describe('CreditWalletCommandSchema', () => {
    describe('Valid Inputs', () => {
      it('should validate a complete valid input with reference', () => {
        ...
        const result = CreditWalletCommandSchema.safeParse(input);
  ...
  describe('CreditWalletCommand Class', () => {
    describe('Constructor', () => {
      it('should create command with all fields', () => {
        ...
        const command = new CreditWalletCommand(input);
    ...
    describe('Static validate()', () => {
      it('should return validated data for valid input', () => {
        ...
        const result = CreditWalletCommand.validate(input);
      ...
      it('should throw ZodError for invalid input', () => {
        ...
        expect(() => CreditWalletCommand.validate(input)).toThrow(z.ZodError);
      });
    });
    ...
    describe('Static safeValidate()', () => {
      it('should return success result for valid input', () => {
        ...
        const result = CreditWalletCommand.safeValidate(input);
